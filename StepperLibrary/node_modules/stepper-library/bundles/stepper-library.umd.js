(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('stepper-library', ['exports', '@angular/core', '@angular/common', '@angular/forms'], factory) :
    (factory((global['stepper-library'] = {}),global.ng.core,global.ng.common,global.ng.forms));
     ...
     */
    var StepsetComponent = /** @class */ (function () {
        function StepsetComponent(rd) {
            this.rd = rd;
            this.steps = [];
            this.stepNo = 0;
            this.totalSteps = 0;
         ...
         * @return {?}
         */
        StepsetComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
         ...
         * @return {?}
         */
        StepsetComponent.prototype.ngAfterViewInit = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        StepsetComponent.prototype.addStep = /**
         * @param {?} step
         * @return {?}
         */
            function (step) {
         ...
         * @return {?}
         */
        StepsetComponent.prototype.jumpToStep = /**
         * @param {?} i
         * @return {?}
         */
            function (i) {
         ...
         * @return {?}
         */
        StepsetComponent.prototype.nextStep = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        StepsetComponent.prototype.setProgressbarColor = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        StepsetComponent.prototype.prevStep = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        StepsetComponent.prototype.setActiveStep = /**
         * @param {?} index
         * @return {?}
         */
            function (index) {
         ...
         * @return {?}
         */
        StepsetComponent.prototype.submit = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        StepsetComponent.ctorParameters = function () {
            return [
                { type: core.Renderer2 }
            ];
        };
        StepsetComponent.propDecorators = {
            ...
            styles: [{ type: core.Input, args: ['finishBtn',] }],
            btnPos: [{ type: core.Input, args: ['btnPos',] }],
            next: [{ type: core.Output }],
            circularBar: [{ type: core.ViewChild, args: ['bar',] }],
            submitEvent: [{ type: core.Output }]
        };
        return StepsetComponent;
    }());

    /**
     * @fileoverview added by tsickle
     * Generated from: lib/stepset/step/step.component.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var StepComponent = /** @class */ (function () {
        function StepComponent(stepset) {
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/stepset/stepset.module.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var StepsetModule = /** @class */ (function () {
        function StepsetModule() {
        }
        StepsetModule.decorators = [
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: stepper-library.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */

    exports.StepsetComponent = StepsetComponent;
    exports.StepComponent = StepComponent;
    exports.StepsetModule = StepsetModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=stepper-library.umd.js.map